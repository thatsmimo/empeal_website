              ...
              <Col md={12} lg={10} className="">
                <div className="_titleDiv _mB-0">
                  ...
                  <p className="_title_txt">
                    ...
                    Health Coaches and Experts in the fields of Nutrition,
                    Fitness, Sleep, Stress Management and Behavioural Change who
                    work together to provide organizations with effective
                    employee wellness programmes with numerous success stories
                    behind their names.
                  </p>
                </div>
              </Col>
            ...
            <Row className="_teamCard-row">
              ...
              <Col md={6} lg={6} className="_teamCard-col">
                <div className="_teamCard">
                  <Row className="">
                    <Col md={12} lg={5}>
                      <div className="_teamCard-fig">
                        <Image
                          src={Assets.images.teamImg1}
                          className="img-fluid"
                        />
                      </div>
                    </Col>
                    <Col md={12} lg={7}>
                      <div className="_teamCard-cont">
                        ...
                        <p className="_txt">
                          Quidam officiis similique tollit indoctum efficiendi
                          tantas.
                        </p>
                  ...
                  <Row className="">
                    ...
                    <Col md={12} lg={7}>
                      <div className="_teamCard-cont">
                        ...
                        <p className="_txt">
                          Te aliquam noluisse his epicuri detracto indoctum.
                        </p>
                        <ul className="_sLinks">
                          <li>
                            <a href="#">
