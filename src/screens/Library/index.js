      ...
      <div className="_libraryPage _topGap">
        ...
        <div className="_librarySection-1 _darkSky  _c-padding">
              ...
              <Col md={12} lg={5} className="">
                ...
                <ul className="_infoLists">
                  <li className="_infoList">
                    ...
                    <p className="_infoTxts">
                      <span>20 august 2019</span> | <span>Nutrition</span>
                    </p>
                  </li>
                  <li className="_infoList">
          ...
          <div className="_l-btm-hill">
            ...
            <span className="_menConv">
              <Image src={Assets.images.menConversation} className="" />
            </span>
          </div>
        </div>
        {/* Section : Begin */}
                            ...
                            <Col md={6} lg={4} className="_blogCol">
                              <div className="_blogDiv">
                                ...
                                <p className="_blogTxt">
                                  His dolorem habemus mandamus et, eius ponderum
                                  lorem molestiae ne, esse vulputate
                                  definitiones iracundia at quo……
                                </p>
                              </div>
                            </Col>
                            {/* Blog Col : End  */}
